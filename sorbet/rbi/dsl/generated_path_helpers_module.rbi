...
module GeneratedPathHelpersModule
  ...
  def api_event_invite_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_event_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_event_post_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_event_posts_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_events_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_geolocation_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_google_maps_places_search_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_login_links_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def redeem_api_login_links_path(*args); end
