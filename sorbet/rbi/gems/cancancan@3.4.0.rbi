...
module CanCan
  class << self
    ...
    #
    # source://cancancan//lib/cancan/config.rb#27
    def accessible_by_strategy; end

    # source://cancancan//lib/cancan/config.rb#44
    def accessible_by_strategy=(value); end

    # source://cancancan//lib/cancan/config.rb#33
    def default_accessible_by_strategy; end

    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/config.rb#74
    ...
    # @raise [ArgumentError]
    #
    # source://cancancan//lib/cancan/config.rb#68
    def validate_accessible_by_strategy!(value); end

    # source://cancancan//lib/cancan/config.rb#54
...
module CanCan::ConditionsMatcher
  ...
  # source://cancancan//lib/cancan/conditions_matcher.rb#106
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#118
  def conditions_empty?; end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#98
  def hash_condition_match?(attribute, value); end

  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#64
  ...
  # @return [Boolean]
  #
  # source://cancancan//lib/cancan/conditions_matcher.rb#52
  def matches_conditions_hash?(subject, conditions = T.unsafe(nil)); end

  # source://cancancan//lib/cancan/conditions_matcher.rb#75
  def matches_hash_conditions(adapter, subject, conditions); end

  # source://cancancan//lib/cancan/conditions_matcher.rb#27
  def matches_non_block_conditions(subject); end

  # source://cancancan//lib/cancan/conditions_matcher.rb#114
...
class CanCan::ModelAdapters::AbstractAdapter
  ...
  #
  # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#61
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/abstract_adapter.rb#52
...
# source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#5
class CanCan::ModelAdapters::ActiveRecordAdapter < ::CanCan::ModelAdapters::AbstractAdapter
  ...
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#16
  def initialize(model_class, rules); end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#89
  def build_relation(*where_conditions); end

  # Returns the value of attribute compressed_rules.
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#14
  ...
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#63
  def conditions; end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#79
  def database_records; end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#73
  def extract_multiple_conditions(conditions_extractor, rules); end

  # Returns the associations used in conditions for the :joins option of a search.
  # See ModelAdditions#accessible_by
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#99
  def joins; end
  ...
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#110
  def deep_clean(joins_hash); end

  # Takes two hashes and does a deep merge.
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#115
  def deep_merge(base_hash, added_hash); end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#160
  def false_sql; end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#140
  ...
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#125
  def override_scope; end

  # @raise [Error]
  #
  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#133
  def raise_override_scope_error; end

  # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#168
  def sanitize_sql(conditions); end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#31
    ...
    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#26
    def override_nested_subject_conditions_matching?(parent, child, all_conditions); end

    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#39
    def parent_child_conditions(parent, child, all_conditions); end

    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#6
    def version_greater_or_equal?(version); end

    # @return [Boolean]
    #
    # source://cancancan//lib/cancan/model_adapters/active_record_adapter.rb#10
